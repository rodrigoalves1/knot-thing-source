...
typedef int (*events_function)(uint8_t sensor_id, knot_data *data);

int knot_thing_protocol_init(uint8_t domain, uint8_t protocol,
		const char *thing_name, data_function read, data_function write,
